/*
g++ BasicFileOperation.cpp -I$CPPET/include -static-libgcc -static-libstdc++ $CPPET/lib/libboost_unit_test_framework.a $CPPET/lib/libboost_system.a $CPPET/lib/libboost_filesystem.a -o BasicFileOperation.exe && strip -s BasicFileOperation.exe && ./BasicFileOperation.exe
*/
#define BOOST_TEST_MODULE BasicFileTest
...
BOOST_AUTO_TEST_SUITE(basic_file_test)

namespace fs = boost::filesystem;

BOOST_AUTO_TEST_CASE(basic_file)
{
